...
import com.udacity.popularmovie.utils.Constants;
import com.udacity.popularmovie.utils.JsonUtils;
...
public class MainActivity extends AppCompatActivity{
    ...
    String option = Constants.POPULAR_QUERY_PARAM;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isOnline ()) {
            ...
            new FetchDataAsyncTask().execute(option);
        } else {
    ...
    protected void onRestoreInstanceState(Bundle outState) {
        ...
        option = outState.getString("OPTION");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.popular_setting) {
            ...
            option = Constants.POPULAR_QUERY_PARAM;
        ...
        if (id == R.id.top_rated_setting) {
            selectedItem = id;
            item.setVisible (true);
            option = Constants.TOP_RATED_QUERY_PARAM;
        ...
        if (id == R.id.favorite_movie_setting){
            selectedItem = id;
            item.setVisible (true);
            option = Constants.FAVORITED_STRING;
